    ...
    <div className="w-full relative">
      ...
      <input
        ...
        className={`
          ...
          errors[id] ? "border-airbnb-theme-color" : "border-neutral-300"
        } ${
          errors[id] ? "focus:border-airbnb-theme-color" : "focus:border-black"
        }
        `}
      />
      <label
        className={` absolute  text-md duration-150 transform -translate-y-3 top-5 z-10 origin-[0] ${
          ...
          errors[id] ? "text-airbnb-theme-color" : "text-airbnb-light-gray"
        }
        `}
      >
        {label}
